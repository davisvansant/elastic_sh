...
fn get(base_url: Url) -> Request {
    ...
    let url = base_url.join("/_cat/snapshots").unwrap();
...
mod tests {
    ...
    fn get_snapshots() {
        ...
        assert_eq!(request_url.as_str(), "http://elasticsearch:9200/_cat/snapshots");
        assert_eq!(request_url.path(), "/_cat/snapshots");
    }
}
