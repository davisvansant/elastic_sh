...
fn get(base_url: Url) -> Request {
    ...
    let url = base_url.join("/_cat/templates").unwrap();
...
mod tests {
    ...
    fn get_templates() {
        ...
        assert_eq!(request_url.as_str(), "http://elasticsearch:9200/_cat/templates");
        assert_eq!(request_url.path(), "/_cat/templates");
    }
}
