...
fn get(base_url: Url) -> Request {
    ...
    let url = base_url.join("/_cat/fielddata").unwrap();
...
mod tests {
    ...
    fn get_fielddata() {
        ...
        assert_eq!(request_url.as_str(), "http://elasticsearch:9200/_cat/fielddata");
        assert_eq!(request_url.path(), "/_cat/fielddata");
    }
}
